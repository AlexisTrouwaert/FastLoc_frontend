        ...
        modale = (<div className="App">
            ...
            <div className={styles.modaleAll}>
                ...
                <div className={styles.inputs}>
                    ...
                    <input type='text' placeholder="E-mail" onChange={e => setInsAt(e.target.value)} className={styles.inputUnit}/>
                    <input type='text' placeholder='Mot de passe' onChange={e => setInsPassword(e.target.value)} className={styles.inputUnit}/>
                </div>
        ...
        modale = (<div className="App">
            ...
            <div className={styles.modaleAll}>
                ...
                <div className={styles.inputs}>
                    ...
                    <input type='text' placeholder='Mot de passe' onChange={e => setCoPassword(e.target.value)} className={styles.inputUnit}/>
                </div>
                <div className={styles.divBtnLogs}>
                {google}
